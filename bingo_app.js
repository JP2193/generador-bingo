...
function buildCellsInline(frases, img5b64) {
  ...
  for (let i = 0; i < 25; i++) {
    if (i === 12) {
      cells.push(`<div style="display:flex;align-items:center;justify-content:center;padding:4px;background:#fdfaf5;border:none;border-radius:9px;overflow:hidden;margin:2px;"><img src="${img5b64}" style="max-width:65%;max-height:65%;width:auto;height:auto;display:block;filter:contrast(1.15) saturate(1.1);"></div>`);
    } else {
